...
const SplashCover = () => {
  ...
  const SplashContainer = useCallback((props) => (
  ...
  const PromoSection = useCallback((props) => (
  ...
  const copyTestnetRPC = useCallback(() => {
    copy(TESTNET_RPC)

    const codeContainer = document.getElementById('CopyTestnetRPC')
    codeContainer.innerText = 'copied!'

    setTimeout(() => {
      codeContainer.innerText = TESTNET_RPC
    }, 2000)
  })

  const copyMainnetRPC = useCallback(() => {
    copy(MAINNET_RPC)

    const codeContainer = document.getElementById('CopyMainnetRPC')
    codeContainer.innerText = 'copied!'

    setTimeout(() => {
      codeContainer.innerText = MAINNET_RPC
    }, 2000)
  })
      ...
      <Row>
        <Col>
          <CardGroup>
            <Card className="mx-3">
              <CardHeader>
                <h2>Lower Gas Costs</h2>
              </CardHeader>

              <CardBody>
                Gas fees only need to be enough to incentivize our already staked DPoS Supernodes to "also" mine our ETH Sidechain blocks.
              </CardBody>
            </Card>
            <Card className="mx-3">
              <CardHeader>
        ...
        <TitleInfo className="TitleInfo">
          <Row>
            ...
            <Col sm="7" className="text-right">
              <div>
                <code className="ml-2" id="CopyTestnetRPC">
                  {TESTNET_RPC}
                </code>
                <CopyIcon className="fa fa-copy" onClick={copyTestnetRPC}/>
              </div>
            </Col>
          </Row>
          <Row>
            ...
            <Col sm="7" className="text-right">
              <code className="ml-2" id="CopyMainnetRPC">
                {MAINNET_RPC}
              </code>
              <CopyIcon className="fa fa-copy" onClick={copyMainnetRPC}/>
            </Col>
          </Row>
          <Row>
            <Col sm="5">
            ...
            <Col sm="7" className="text-right">
              <a href="https://explorer.elaeth.io">
                <code className="ml-2">
